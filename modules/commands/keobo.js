...
module.exports.config = {
	name: "keobo", // Tên lệnh, được sử dụng trong việc gọi lệnh
	version: "1.0.0", // phiên bản của module này
	hasPermssion: 0, // Quyền hạn sử dụng, với 0 là toàn bộ thành viên, 1 là quản trị viên trở lên, 2 là admin/owner
	credits: "DũngUwU & TruongNon", // Công nhận module sở hữu là ai
...
module.exports.handleEvent = async({ api, event, Currencies, Users }) => {
    ...
    if(input == "kéo") {
        ...
        console.log(global.client.keobo[senderID].count);
        if (global.client.keobo[senderID].count > 1) return;
        setTimeout(async () => {
           let { data } = await axios.get(`https://keobo.sdwdewhgdjwwdjs.repl.co/keobo/${global.client.keobo[senderID].count}_${global.client.keobo[senderID].bo}_${key}`) 
